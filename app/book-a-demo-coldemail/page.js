...
export const metadata = buildMetadata(seoData.bookADemocoldemail);
    ...
    <>
      <JsonLd
        data={breadcrumbSchema([
          { name: 'Home', path: '/' },
          { name: 'Book a Demo', path: '/book-a-demo-coldemail' },
        ])}
      />
      ...
      <FormPageHero
        ...
        form={<EmbedForm slug="aiengage-crm-book-a-demo-form-copy" title="AiEngage CRM - Book a Demo Form" />}
      >
