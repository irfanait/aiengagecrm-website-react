...
import { AnalyticsMock } from '../../../components/organisms/WhatsAppMocks/WhatsAppMocks';
...
const page = WHATSAPP_SUBPAGES.analytics;
    ...
    <>
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: page.breadcrumbLabel, path: '/whatsapp/analytics' },
        ])}
      />
