...
import { BroadcastMock } from '../../../components/organisms/WhatsAppMocks/WhatsAppMocks';
...
const page = WHATSAPP_SUBPAGES.broadcast;
    ...
    <>
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: page.breadcrumbLabel, path: '/whatsapp/broadcast' },
        ])}
      />
