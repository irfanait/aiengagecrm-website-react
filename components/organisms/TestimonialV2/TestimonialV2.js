...
function QuoteIcon() {
  return (
    <svg width="40" height="20" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.quoteIcon}>
      <g clipPath="url(#testiV2QuoteClip)">
...
export default function TestimonialV2() {
  return (
    <section className={styles.section}>
      <Container>
        <h2 className={styles.heading}>Why Teams Love AiEngage CRM</h2>

        <Carousel dots autoplay autoplaySpeed={6000} className={styles.carousel}>
