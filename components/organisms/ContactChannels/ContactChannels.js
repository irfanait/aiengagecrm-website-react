...
/** Icon rows box ("ways to reach us") on the Contact Us hero. */
export default function ContactChannels({ items }) {
  return (
    <>
      <div className={styles.label}>Ways to reach us</div>
      <div className={styles.box}>
        {items.map((c) => {
          ...
          return (
            <Tag key={c.label} className={styles.row} {...linkProps}>
              <span className={styles.iconBox}>
                {c.icon === 'whatsapp' ? (
                  <svg width={22} height={22} viewBox="-23 -21 682 682.66669" fill="var(--color-primary)" aria-hidden="true">
              ...
              <div className={styles.rowBody}>
                ...
                {c.linkLabel ? (
                  ...
                  <div className={styles.rowValue}>{c.value}</div>
                )}
              </div>
            </Tag>
          );
