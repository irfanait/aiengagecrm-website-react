...
import styles from './NewPricingComparison.module.css';

/** "Traditional CRMs" vs "AiEngage" stacked comparison cards, under a centered heading. */
export default function NewPricingComparison({ titleLead, titleAccent, titleTail, aiList, tradList, ctaLabel, ctaHref }) {
  return (
