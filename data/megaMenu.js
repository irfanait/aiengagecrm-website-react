...
export const MEGA_MENU = [
  {
    ...
    features: [
      ['Email Marketing', 'outgoing_mail', 'Create targeted email campaigns and manage customer communication from one place.', '/multichannel-communication'],
      ...
      ['AI Chatbot', 'smart_toy', 'Capture website inquiries and answer customer questions automatically with AI.', '/ai'],
      ...
      ['Web Forms', 'list_alt', 'Create lead capture forms for website, landing pages, campaigns, and inquiries.', '/lead-management'],
      ...
      ['Marketing Analytics', 'monitoring', 'Track campaign engagement, performance, conversions, and marketing results.', '/marketing-campaigns'],
      ['Dashboards & Reporting', 'dashboard', 'Monitor campaign, sales, team, and business performance using customizable reports.', '/reports-analytics'],
    ],
  },
  {
    name: 'Sales Suite',
    ...
    features: [
      ...
      ['Sales AI Agent', 'smart_toy', 'Use AI to identify leads, qualify hot leads, and support your sales team with next actions.', '/sales-pipeline'],
      ...
      ['Calling & Tracking', 'call', 'Make and receive customer calls with recordings, transcripts, call logs, and follow-up tracking.', '/calling'],
      ['Meeting Scheduler', 'event', 'Share booking links, manage availability, schedule meetings, and connect Zoom or Google Meet.', '/meetings-calendars'],
      ...
      ['Sales Analytics & Reporting', 'query_stats', 'Track pipeline performance, conversions, activities, targets, and sales outcomes.', '/sales-pipeline'],
    ],
  },
  {
    ...
    features: [
      ['AI Support Agents', 'smart_toy', 'Use AI to answer customer questions, handle routine requests, and assist support teams automatically.', '/customer-service-support'],
      ['Inbox', 'inbox', 'Manage customer conversations, replies, and follow-ups from a shared communication inbox.', '/customer-service-support'],
