// Static fallback data source for /whats-new — the original hand-authored entries, kept as
// an escape hatch. Default data source is the live CMS API (see utils/whatsNewApi.js); set
// WHATS_NEW_SOURCE=static in .env.local to switch app/whats-new/page.js and
// app/whats-new/[slug]/page.js back to reading from WN_ENTRIES below instead, with no other
// code changes needed. Adding an update here (in static mode) is a data-only change:
