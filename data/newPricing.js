...
export const NP_PLANS = [
  {
    ...
    name: 'Solo',
    priceKey: 'solo',
    signupProductId: 'prod_V8zKT2REMDAiGM',
  ...
  },
  {
    ...
    name: 'Business',
    priceKey: 'business',
    signupProductId: 'prod_V8zK7SiHfWZNEX',
  ...
  },
  {
    ...
    signupProductId: 'prod_V8zKYwQHOh9HE1',
...
export const NP_FEATURE_TABLE = [
  {
    ...
    rows: [
      { label: 'Total Users/Seats', sub: null, solo: '1', business: 'Up to 5', businessPro: 'Up to 10' },
      {
        ...
        business: '20,000',
        businessPro: '50,000',
        addon: 'Extra 5,000 Contacts — $5/month',
      },
      {
        label: 'File storage',
        sub: null,
        ...
        business: '5 GB',
        businessPro: '10 GB',
        addon: 'Extra 20 GB Storage — $6/month',
      },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Multi-sender email accounts', sub: 'Connected sending addresses', solo: '5', business: '5', businessPro: '10' },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'AI Inbox Intelligence', sub: 'Analyze, Prioritize & Respond Smarter', solo: true, business: true, businessPro: true },
      { label: 'AI Chat Closing', sub: 'Automatically Close Conversations', solo: true, business: true, businessPro: true },
      { label: 'Integration with AI Platforms', sub: 'ChatGPT, Claude, Gemini and more', solo: true, business: true, businessPro: true },
      { label: 'MCP for Custom AI Agent Integration', sub: null, solo: true, business: true, businessPro: true },
    ],
  },
  {
    icon: 'notifications',
